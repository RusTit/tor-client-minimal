...
Tor client (Socks proxy ) version 0.4.8.14-r1 image - Tor client image qualified for Docker on Synology NAS. This Docker image launch a Tor client with a Socks proxy on port 9150 (SocksPort 0.0.0.0:9150).
...
Tor : version 0.4.8.14-r1
Lyrebird: version 0.5.0-r3
